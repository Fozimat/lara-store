...
<div class="page-content page-details">
    ...
    <div class="store-details-container" data-aos="fade-up">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="owner">by Fozimat Amhas</div>
        ...
        <section class="store-reviews">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-8 mt-3 mt-3 mb-3">
                        ...
                        <ul class="list-unstyled">
                            <li class="media">
                                ...
                                <div class="media-body">
                                    <h5 class="mt-2 mb-1">Lisa Adriana</h5>
                            ...
                            <li class="media">
                                ...
                                <div class="media-body">
                                    <h5 class="mt-2 mb-1">Angelia Minasan</h5>
